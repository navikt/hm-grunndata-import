    ...
    fun crudRepositoryTest() {
        ...
        val product = ProductTransferDTO(title = "Mini Crosser X1 4W",  isoCategory = "12230301" , hmsArtNr = "250464",
            ...
            attributes = mapOf(Pair(AttributeNames.manufacturer, "Medema AS"),
                Pair(AttributeNames.shortdescription, listOf("4-hjuls scooter med manuell regulering av seteløft, ryggvinkel og seterotasjon. Leveres som standard med Ergo2 sitteenhet.")),
                Pair("description", listOf("""Mini Crosser modell X1/ X2
